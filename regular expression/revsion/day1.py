...
strA = 'cat man sun mpo run mat mm9 sun'

A = re.search(r'm\w\w', strA)
...
C = re.search(r'\w\wp', strB)
if C:
    print(C.group())
else:
    print("not found")

D = re.findall(r'm\w\w', strB)
E = re.findall(r'\wat', strB)
print(D)
print(E)
...
# program 4
strD = "there; &where is a way 'their' *is $a way"

G = re.split(r"\W+", strD)
print(G)

info = 'Vrushali:8530420563'
print(re.split(r'\W+', info))

# program 5
strE = "I am learning javascript"
H = re.sub(r'javascript', 'python', strE)
print(H)
